...
CREATE TABLE `cart`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `tablename` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'miaoshashangpin' COMMENT '茶叶表名',
  `userid` bigint NOT NULL COMMENT '用户id',
  `goodid` bigint NOT NULL COMMENT '茶叶id',
  `goodname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '茶叶名称',
  ...
  `goodtype` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '茶叶类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1709783520633 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '购物车表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of cart
-- ----------------------------
INSERT INTO `cart` VALUES (1709782960585, '2024-03-07 11:42:40', 'shangpinxinxi', 1678240351849, 42, '茶叶名称2', 'upload/shangpinxinxi_tupian2.jpg', 1, 99.9, 0, '1', '茶叶分类2');
INSERT INTO `cart` VALUES (1709783520632, '2024-03-07 11:51:59', 'shangpinxinxi', 1678240351849, 43, '茶叶名称3', 'upload/shangpinxinxi_tupian3.jpg', 1, 99.9, 0, '1', '茶叶分类3');
...
CREATE TABLE `discussmiaoshashangpin`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '秒杀茶叶评论表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `discussshangpinxinxi`  (
  ...
  `reply` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '回复内容',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1678240807027 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '茶叶信息评论表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `miaoshashangpin`  (
  ...
  `shangpinxiangqing` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '茶叶详情',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '秒杀茶叶' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of miaoshashangpin
-- ----------------------------
INSERT INTO `miaoshashangpin` VALUES (51, '2024-03-07 10:38:03', '茶叶名称1', '茶叶分类1', '品牌1', 'upload/miaoshashangpin_tupian1.jpg,upload/miaoshashangpin_tupian2.jpg,upload/miaoshashangpin_tupian3.jpg', '<p>茶叶详情1</p>', '1', '2024-03-07', 1, 99, '2024-03-07 11:42:28', '2023-03-09 00:00:00', 99.9);
INSERT INTO `miaoshashangpin` VALUES (52, '2024-03-07 10:38:03', '限时衣服', '衣服', '品牌2', 'upload/miaoshashangpin_tupian2.jpg', '<p>茶叶详情2测试</p>', '1', '2024-03-07', 2, 0, '2024-03-07 11:42:48', '2023-03-09 00:00:00', 250);
INSERT INTO `miaoshashangpin` VALUES (53, '2024-03-07 10:38:03', '茶叶名称3', '茶叶分类3', '品牌3', 'upload/miaoshashangpin_tupian3.jpg,upload/miaoshashangpin_tupian4.jpg,upload/miaoshashangpin_tupian5.jpg', '<p>茶叶详情3</p>', '1', '2024-03-07', 3, 99, '2023-03-08 09:47:43', '2023-03-09 00:00:00', 99.9);
INSERT INTO `miaoshashangpin` VALUES (54, '2024-03-07 10:38:03', '茶叶名称4', '茶叶分类4', '品牌4', 'upload/miaoshashangpin_tupian4.jpg,upload/miaoshashangpin_tupian5.jpg,upload/miaoshashangpin_tupian6.jpg', '茶叶详情4', '账号4', '2024-03-07', 4, 99, '2023-03-08 09:39:40', '2023-03-09 00:00:00', 99.9);
INSERT INTO `miaoshashangpin` VALUES (55, '2024-03-07 10:38:03', '茶叶名称5', '茶叶分类5', '品牌5', 'upload/miaoshashangpin_tupian5.jpg,upload/miaoshashangpin_tupian6.jpg,upload/miaoshashangpin_tupian7.jpg', '茶叶详情5', '账号5', '2024-03-07', 5, 99, '2023-03-08 09:39:40', '2023-03-09 00:00:00', 99.9);
INSERT INTO `miaoshashangpin` VALUES (56, '2024-03-07 10:38:03', '茶叶名称6', '茶叶分类6', '品牌6', 'upload/miaoshashangpin_tupian6.jpg,upload/miaoshashangpin_tupian7.jpg,upload/miaoshashangpin_tupian8.jpg', '茶叶详情6', '账号6', '2024-03-07', 6, 99, '2023-03-08 09:39:40', '2023-03-09 00:00:00', 99.9);
INSERT INTO `miaoshashangpin` VALUES (57, '2024-03-07 10:38:03', '茶叶名称7', '茶叶分类7', '品牌7', 'upload/miaoshashangpin_tupian7.jpg,upload/miaoshashangpin_tupian8.jpg,upload/miaoshashangpin_tupian9.jpg', '茶叶详情7', '账号7', '2024-03-07', 7, 99, '2023-03-08 09:39:40', '2023-03-09 00:00:00', 99.9);
INSERT INTO `miaoshashangpin` VALUES (58, '2024-03-07 10:38:03', '茶叶名称8', '茶叶分类8', '品牌8', 'upload/miaoshashangpin_tupian8.jpg,upload/miaoshashangpin_tupian9.jpg,upload/miaoshashangpin_tupian10.jpg', '茶叶详情8', '账号8', '2024-03-07', 8, 99, '2023-03-08 09:39:40', '2023-03-09 00:00:00', 99.9);
...
CREATE TABLE `orders`  (
  ...
  `goodid` bigint NOT NULL COMMENT '茶叶id',
  `goodname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '茶叶名称',
  `picture` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '茶叶图片',
  `buynumber` int NOT NULL COMMENT '购买数量',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1709783087064 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1678240707351, '2024-03-07 10:38:03', '20233895831362', 'shangpinxinxi', 1678240351849, 43, '茶叶名称3', 'upload/shangpinxinxi_tupian3.jpg', 2, 99.9, 99.9, 199.8, 199.8, 1, '已取消', 'xx地址', '15214121411', '王丽', '1111', NULL, '1', '茶叶分类3');
...
INSERT INTO `orders` VALUES (1678240707703, '2024-03-07 10:38:03', '20233895831361', 'shangpinxinxi', 1678240351849, 48, '茶叶名称8', 'upload/shangpinxinxi_tupian8.jpg', 2, 99.9, 99.9, 199.8, 199.8, 1, '已取消', 'xx地址', '15214121411', '王丽', '1111', NULL, '账号8', '茶叶分类8');
INSERT INTO `orders` VALUES (1678240708250, '2024-03-07 10:38:03', '20233895831360', 'shangpinxinxi', 1678240351849, 42, '茶叶名称2', 'upload/shangpinxinxi_tupian2.jpg', 2, 99.9, 99.9, 199.8, 199.8, 1, '未支付', 'xx地址', '15214121411', '王丽', '1111', NULL, '1', '茶叶分类2');
INSERT INTO `orders` VALUES (1678240754093, '2024-03-07 10:38:03', '20233895917931', 'shangpinxinxi', 1678240351849, 42, '茶叶名称2', 'upload/shangpinxinxi_tupian2.jpg', 2, 99.9, 99.9, 199.8, 199.8, 1, '已支付', 'xx地址', '15214121411', '王丽', '111', NULL, '1', '茶叶分类2');
INSERT INTO `orders` VALUES (1678240754533, '2024-03-07 10:38:03', '20233895917937', 'shangpinxinxi', 1678240351849, 43, '茶叶名称3', 'upload/shangpinxinxi_tupian3.jpg', 2, 99.9, 99.9, 199.8, 199.8, 1, '已退款', 'xx地址', '15214121411', '王丽', '111', NULL, '1', '茶叶分类3');
INSERT INTO `orders` VALUES (1678240754600, '2024-03-07 10:38:03', '20233895917932', 'shangpinxinxi', 1678240351849, 48, '茶叶名称8', 'upload/shangpinxinxi_tupian8.jpg', 2, 99.9, 99.9, 199.8, 199.8, 1, '已退款', 'xx地址', '15214121411', '王丽', '111', NULL, '账号8', '茶叶分类8');
...
INSERT INTO `orders` VALUES (1709782964239, '2024-03-07 11:42:43', '202437114243390', 'shangpinxinxi', 1678240351849, 42, '茶叶名称2', 'upload/shangpinxinxi_tupian2.jpg', 1, 99.9, 99.9, 99.9, 99.9, 1, '已退款', 'xx地址', '15214121411', '王丽', '', NULL, '1', '茶叶分类2');
INSERT INTO `orders` VALUES (1709783087063, '2024-03-07 11:44:46', '202437114446139', 'shangpinxinxi', 1678240351849, 1709783037107, 'ceshishangpin222', 'upload/1709783046843.png', 1, 1000, 1000, 1000, 1000, 1, '已支付', 'xx地址', '15214121411', '王丽', '', NULL, '1', '茶叶分类1');
...
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '茶叶分类' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of shangpinfenlei
-- ----------------------------
INSERT INTO `shangpinfenlei` VALUES (31, '2024-03-07 10:38:03', '茶叶分类1');
INSERT INTO `shangpinfenlei` VALUES (32, '2024-03-07 10:38:03', '茶叶分类2');
INSERT INTO `shangpinfenlei` VALUES (33, '2024-03-07 10:38:03', '茶叶分类3');
INSERT INTO `shangpinfenlei` VALUES (34, '2024-03-07 10:38:03', '茶叶分类4');
INSERT INTO `shangpinfenlei` VALUES (35, '2024-03-07 10:38:03', '茶叶分类5');
INSERT INTO `shangpinfenlei` VALUES (36, '2024-03-07 10:38:03', '茶叶分类6');
...
CREATE TABLE `shangpinxinxi`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1709783037108 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '茶叶信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of shangpinxinxi
-- ----------------------------
INSERT INTO `shangpinxinxi` VALUES (42, '2024-03-07 10:38:03', '茶叶名称2', '茶叶分类2', 'upload/shangpinxinxi_tupian2.jpg,upload/shangpinxinxi_tupian3.jpg,upload/shangpinxinxi_tupian4.jpg', '品牌2', '1', '2024-03-07', '<p>茶叶详情2</p>', 2, 95, '2024-03-07 11:42:52', 99.9, 2);
INSERT INTO `shangpinxinxi` VALUES (43, '2024-03-07 10:38:03', '茶叶名称3', '茶叶分类3', 'upload/shangpinxinxi_tupian3.jpg,upload/shangpinxinxi_tupian4.jpg,upload/shangpinxinxi_tupian5.jpg', '品牌3', '1', '2024-03-07', '<p>茶叶详情3</p>', 3, 97, '2024-03-07 11:51:52', 99.9, 3);
INSERT INTO `shangpinxinxi` VALUES (44, '2024-03-07 10:38:03', '茶叶名称4', '茶叶分类4', 'upload/shangpinxinxi_tupian4.jpg,upload/shangpinxinxi_tupian5.jpg,upload/shangpinxinxi_tupian6.jpg', '品牌4', '账号4', '2024-03-07', '茶叶详情4', 4, 99, '2023-03-08 09:39:40', 99.9, 4);
INSERT INTO `shangpinxinxi` VALUES (45, '2024-03-07 10:38:03', '茶叶名称5', '茶叶分类5', 'upload/shangpinxinxi_tupian5.jpg,upload/shangpinxinxi_tupian6.jpg,upload/shangpinxinxi_tupian7.jpg', '品牌5', '账号5', '2024-03-07', '茶叶详情5', 5, 99, '2023-03-08 09:39:40', 99.9, 5);
INSERT INTO `shangpinxinxi` VALUES (46, '2024-03-07 10:38:03', '茶叶名称6', '茶叶分类6', 'upload/shangpinxinxi_tupian6.jpg,upload/shangpinxinxi_tupian7.jpg,upload/shangpinxinxi_tupian8.jpg', '品牌6', '账号6', '2024-03-07', '茶叶详情6', 6, 99, '2023-03-08 09:39:40', 99.9, 6);
INSERT INTO `shangpinxinxi` VALUES (47, '2024-03-07 10:38:03', '茶叶名称7', '茶叶分类7', 'upload/shangpinxinxi_tupian7.jpg,upload/shangpinxinxi_tupian8.jpg,upload/shangpinxinxi_tupian9.jpg', '品牌7', '账号7', '2024-03-07', '茶叶详情7', 7, 99, '2023-03-08 09:39:40', 99.9, 7);
INSERT INTO `shangpinxinxi` VALUES (48, '2024-03-07 10:38:03', '茶叶名称8', '茶叶分类8', 'upload/shangpinxinxi_tupian8.jpg,upload/shangpinxinxi_tupian9.jpg,upload/shangpinxinxi_tupian10.jpg', '品牌8', '账号8', '2024-03-07', '茶叶详情8', 8, 99, '2023-03-08 09:59:27', 99.9, 8);
INSERT INTO `shangpinxinxi` VALUES (1709783037107, '2024-03-07 11:43:56', 'ceshishangpin222', '茶叶分类1', 'upload/1709783046843.png', '33', '1', '2024-03-07', '', 3, 332, '2024-03-07 11:44:46', 1000, -1);
...
CREATE TABLE `storeup`  (
  ...
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `userid` bigint NOT NULL COMMENT '用户id',
  `refid` bigint NULL DEFAULT NULL COMMENT '茶叶id',
...
-- Records of storeup
-- ----------------------------
INSERT INTO `storeup` VALUES (1678240651582, '2024-03-07 10:38:03', 1678240351849, 48, 'shangpinxinxi', '茶叶名称8', 'upload/shangpinxinxi_tupian8.jpg', '1', '茶叶分类8', NULL);
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 1, 'admin', 'users', '管理员', '5kug0kqbj2kdvwu3as1l23kq4bemx2k8', '2024-03-07 10:38:03', '2026-02-15 14:26:46');
