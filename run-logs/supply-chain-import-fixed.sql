ALTER TABLE `shangpinxinxi`
  ADD COLUMN `chandi` varchar(200) DEFAULT NULL COMMENT '产地',
  ADD COLUMN `haiba` int DEFAULT NULL COMMENT '海拔',
  ADD COLUMN `shengchanpici` varchar(100) DEFAULT NULL COMMENT '生产批次',
  ADD COLUMN `shiyongchangjing` varchar(200) DEFAULT NULL COMMENT '适饮场景';
...
VALUES
  (202604220001,'TB-001','云岭一号高山茶园','福建省武夷山市星村镇',860,128.50,'陈建国','13800000001','高山绿茶','绿色食品认证','账号8','重点展示基地'),
...
VALUES
  (202604220201,'PC202604-A01','茶叶名称2','入库',118.00,118.00,40.00,'2026-04-15 09:00:00','账号8',NULL,'春茶批次首次入库'),
  (202604220202,'PC202604-A01','茶叶名称2','出库',-82.00,36.00,40.00,'2026-04-20 15:30:00','账号8','20260422001','库存已接近预警线'),
  (202604220203,'PC202604-A02','茶叶名称4','入库',105.00,105.00,35.00,'2026-04-16 10:00:00','账号4',NULL,'红茶批次入库');
